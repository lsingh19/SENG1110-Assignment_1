...
public class Account
{
   ...
   public String setAmortizationTable()
   {
       ...
       while (counter <= numberOfMonths) 
       {
           ...
           data += counter;
           data += String.format("%23s", "$" + Double.toString(Math.round(initBalance*100.0)/100.0)); 
           data += String.format("%23s", "$" + Double.toString(Math.round(monthlyPayment*100.0)/100.0));
           data += String.format("%26s", "$" + Double.toString(Math.round(interestPaid*100.0)/100.0)); 
           data += String.format("%23s", "$" + Double.toString(Math.round(principalPaid*100.0)/100.0));
           data += String.format("%23s", "$" + Double.toString(Math.round(finalBalance*100.0)/100.0));
           data += "\n";
           ...
           // The month number is increased by 1
           counter++; 
